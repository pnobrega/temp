...
<body id="page-top">
    ...
    <div class="container">
        <br>
        <h2 class="text-uppercase text-center text-secondary mb-0">You are Successfully Logged in</h2>
        <p class="padding text-center ">This page should only be accessible once logged in (using session variable). Below are the records in our 'user' table in our 'login' database:</p>
